...
function help {
    ...
    echo "OPTIONS"
    echo
    echo "    -A|--sample1                         : Name of sample you want to use as it appears on the Tinkerbox"
    ...
    echo "    -G|--genome                          : The genome build the sample has been processed using. Strictly hg19, hg38, or mm10"
