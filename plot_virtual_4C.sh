...
function help {
    ...
    echo "  [ -B|--sample2        ]   : Name of the second sample you want to use as it appears on the Tinkerbox"
    ...
    echo "  [    --quant_cut      ]   : Rather than using the max value of the matrix as the highest color, cap the values at a given percentile. Between 0.00-1.00. Default 1.00"
    echo "  [    --max_cap        ]   : Set a hard cap, all values greater than this will be brought down to cap value supplied"
    ...
    echo "  [    --inherent       ]   : TRUE or FALSE. If TRUE, normalize the contact plot using inherent normalization"
